...
import 'package:custom_fragment_shader/slides/agenda04/agenda04_hologram_effect02_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_hologram_effect03_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_hologram_effect04_slide.dart';
...
import 'package:custom_fragment_shader/slides/agenda04/agenda04_ink_sparkle03_slide.dart';
...
import 'package:custom_fragment_shader/slides/agenda04/agenda04_pixelation04_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_pixelation05_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_pixelation06_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_pixelation07_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_pixelation08_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_title_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_transition01_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_transition02_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_transition03_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_transition04_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_transition05_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_transition06_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_transition07_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_transition08_slide.dart';
import 'package:custom_fragment_shader/slides/agenda04/agenda04_transition09_slide.dart';
...
const _slides = <SlideWidget>[
  ...
  Agenda04Pixelation03Slide(),
  Agenda04Pixelation04Slide(),
  Agenda04Pixelation05Slide(),
  Agenda04Pixelation06Slide(),
  ...
  Agenda04HologramEffect04Slide(),
  Agenda04HologramEffect05Slide(),
  Agenda04HologramEffect06Slide(),
  Agenda04InkSparkle01Slide(),
  Agenda04InkSparkle02Slide(),
  Agenda04InkSparkle03Slide(),
  Agenda04Transition01Slide(),
  Agenda04Transition02Slide(),
  Agenda04Transition03Slide(),
  Agenda04Transition04Slide(),
  Agenda04Transition05Slide(),
  Agenda04Transition06Slide(),
  Agenda04Transition07Slide(),
  Agenda04Transition08Slide(),
  Agenda04Transition09Slide(),
  OutroSlide(),
];
...
class _PresentationAppState extends State<PresentationApp> {
  ...
  Widget build(BuildContext context) {
    final speakerNote = _slides[_slideIndex].speakerNote;
    return MaterialApp(
      home: Scaffold(
