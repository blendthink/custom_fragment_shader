...
final class Agenda02OImplementationFlowStep2Slide extends SlideStatelessWidget {
  const Agenda02OImplementationFlowStep2Slide({super.key});
...
次に、作成した Fragment Shader 用のプログラムファイルをアプリで読み込む部分を実装していきます。''';
}
