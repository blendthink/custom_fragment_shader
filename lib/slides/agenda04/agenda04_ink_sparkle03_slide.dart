...
ご覧のように引数が多く、まだアプリ側に多くの処理が残っているようでした。
右側がアプリ側のコードで、Fragment Shader に値を渡している部分の実装です。

Fragment Shader の実際の処理はここで表示しているよりもっと多いですが時間の都合上省略しています。
GitHub でコードは公開されていますので、もし興味ある方は後からご覧ください。
