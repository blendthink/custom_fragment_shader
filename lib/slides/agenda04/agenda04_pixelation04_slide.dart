...
`uniform` というキーワードは、Shader がそのフレームで処理する全てのピクセルで変数の値が同じである、ということを表しています。

慣例として、変数名の先頭に u を付けることが多いようです。
変数の型をみてみると、vec2 と float は馴染みのある方が多いと思いますが、sampler2D は初めて見る方もいるかもしれません。
